...
-- 실습 1-10
SELECT PNAME, PRICE+500 AS 조정단가 FROM PRODUCT; // 어케햇노 ㅋㅋㅋㅋ

-- 실습 1-11
SELECT PNAME, STOCK, PRICE FROM PRODUCT WHERE PNAME = '초코파이' OR PNAME = '포카칩';

-- 실습 1-12
SELECT ORD_PNO, ORD_CNT, ORD_DATE FROM ORDERS WHERE ORD_CID = 'c102' ORDER BY ORD_PNO DESC;

-- 실습 1-13
SELECT ORD_PNO, ORD_CNT, ORD_DATE FROM ORDERS WHERE ORD_CID = 'c102' AND ORD_CNT > 1 ORDER BY ORD_PNO DESC; 

-- 실습 1-14
SELECT * FROM PRODUCT WHERE PRICE >= 1000 AND PRICE <= 2000 ORDER BY PNO ASC;

-- 실습 1-15
SELECT CID, NAME, HP, ADDRESS FROM CUSTOMER WHERE NAME LIKE '김%' ORDER BY CID ASC;

-- 실습 1-16
SELECT CID, NAME, HP, ADDRESS FROM CUSTOMER WHERE NAME LIKE '__' ORDER BY CID ASC;
...
-- 실습 1-20
SELECT * FROM ORDERS WHERE ORD_CNT >= 3 ORDER BY ORD_CNT DESC, ORD_NO DESC;
...
-- 실습 1-28
SELECT ORD_PNO, ORD_CID, SUM(ORD_CNT)AS "총 주문수량" FROM ORDERS GROUP BY ORD_PNO, ORD_CID ORDER BY ORD_PNO ASC;

-- 실습 1-29 ORDERS와 PRODUCT의 JOIN
